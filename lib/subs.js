...
const templates = [
    "As Commander-in-Chief, my ${adjective} priority is the ${noun} of our great country. We cannot surrender ${adjective} control over the nation’s ${noun} to ${adjective} cartels, ${noun}, and ${noun}. We {verb} future Americans to ${verb} to our country ${adverb} and through a system based on ${noun}. We need ${noun} to ${verb} to our country."
];

//console.log(util.grammar);
